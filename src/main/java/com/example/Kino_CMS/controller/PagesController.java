...
public class PagesController {
    ...
    public PagesController(PageRepository pageRepository, MainPageRepository mainPageRepository, AboutCinemaRepository aboutCinemaRepository, VipHallRepository vipHallRepository, AdvertisingRepository advertisingRepository, KidsRoomRepository kidsRoomRepository, CinemaContactsRepository contactsRepository, ContactForTableRepository contactForTableRepository) {
